        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ trans('admin.edit_invoice') }}</h4>
                </div>
                                        ...
                                        <table class="table" id="invoice_details">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="6">
                                                        <button type="button"
                                                            class="btn_add btn btn-primary">{{ trans('admin.add_another_product') }}</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3"></td>
                                                    ...
                                                    <td>
                                                        <div class="input-group mb-3">
                                                            <select name="discount_type" id="discount_type"
                                                                ...
                                                                <option value="percentage">{{ trans('admin.percentage') }}
                                                                </option>
                                                            </select>
